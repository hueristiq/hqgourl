...
func TestNewExtractor(t *testing.T) {
	...
	defaultExtractor := hqgourl.NewURLExtractor()

	if defaultExtractor == nil {
		t.Errorf("NewURLExtractor() with no options returned nil")
	}

	schemeExtractor := hqgourl.NewURLExtractor(
		hqgourl.URLExtractorWithScheme("http", "https"),
	)

	if schemeExtractor == nil {
		t.Errorf("NewURLExtractor() with WithScheme option returned nil")
	}

	hostExtractor := hqgourl.NewURLExtractor(
		hqgourl.URLExtractorWithHost("example.com"),
	)

	if hostExtractor == nil {
		t.Errorf("NewURLExtractor() with WithHost option returned nil")
	}
}
...
func TestCompileRegex(t *testing.T) {
	...
	if regex == nil {
		t.Errorf("CompileRegex() returned nil")
	}
}
...
func TestURLExtractionWithScheme(t *testing.T) {
	...
	extractor := hqgourl.NewURLExtractor(
		hqgourl.URLExtractorWithScheme(),
	)
...
func TestURLExtractionWithCustomScheme(t *testing.T) {
	t.Parallel()
