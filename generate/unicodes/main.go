...
var (
	...
	tmpl = template.Must(template.New("schemes").Parse(`// This file is autogenerated by https://github.com/hueristiq/hqgourl/blob/main/generate/unicodes/main.go. Please do not edit manually.
